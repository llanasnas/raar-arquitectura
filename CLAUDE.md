...
| `app/page.tsx` | **La portada** (= la propuesta C desde el 17/09/2026): apertura de persiana + `Cover` + `Diagram` + `Feature` + `Statement` + `Closing`. `/home-c` redirige aquí |
...
Datos legales y de socios · fotos de obra terminada y testimonios · nombres públicos, año, m² y estado de cada proyecto · material de BO24, CM25 y LL14 (sin ficha: en el diagrama van sin enlace) · sección «Off grid» (eventos y camisetas, tipo boletín; no existe aún) · **servicios a cinco** (Obra nueva, Rehabilitación, Project management, Dirección de obra, Interiorismo: faltan textos de los tres nuevos) · si IM10 y TO39 van en la home · GV75/SE08/PR37/GR16 · CA/EN (estructura preparada en `lib/copy.ts` y `content/projects/es/`) · Resend en producción · 301 desde `/works.html`, `/worksXX.html`.
